...
//       description:
//         "Highly rated for family-centered care and child-friendly staff.",
//       rating: 4.5,
//     },
//     {
...
//       description:
//         "Known for fast emergency response and efficient diagnostics.",
//       rating: 4.2,
//     },
//     {
...
//               <div key={index} className="flex bg-wh shadow rounded-xl py-[40px] px-[20px] bg-[#F0F3F6]">
//                 <div>
//                   <h2 className="text-xl font-semibold mb-1 w-[170px]">
//                     {clinic.name}
//                   </h2>
//                   <img
//                     src={clinic.image}
...
//                   />
//                   <div className="flex flex-col justify-center text-center my-[20px] mb-2 bg-[#FDFDFD] rounded-[10px] w-[140px] ">
...
//                   <div className="grid grid-cols-2 gap-x-4 text-sm mb-2 bg-[#FDFDFD] rounded-[20px] p-[20px]  w-[510px]">
...
//                     </div>
//                   </div>
//                   <p className="text-sm text-[#0E3924] mb-2">
//                     {clinic.description}
//                   </p>
...
//                       Book Appointment
//                     </button>
//                     <button className="border border-green-600 text-green-600 px-4 py-1 rounded">
//                       Save for Later
//                     </button>
//                   </div>
//                 </div>
